...
class AuiTabContainer(object):
    ...
    def SetRect(self, rect, wnd=None):
        """
    ...
    def AddButton(self, id, location, normalBitmap=wx.BitmapBundle(), disabledBitmap=wx.BitmapBundle()):
        """
...
class AuiTabArt(object):
    ...
    def SetSizingInfo(self, tab_ctrl_size, tab_count, wnd=None):
        """
