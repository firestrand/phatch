...
class Frame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.menu_file_export_actionlist_to_clipboard = wx.MenuItem(menu_file_export, wx.NewIdRef(), _("Copy Actionlist as &Command to Clipboard"), _("Paste this command in a launcher"), wx.ITEM_NORMAL)
        menu_file_export.Append(self.menu_file_export_actionlist_to_clipboard)
        self.menu_file_export_recent_to_clipboard = wx.MenuItem(menu_file_export, wx.NewIdRef(), _("Copy R&ecent as Command to Clipboard"), _("Paste this command in a launcher"), wx.ITEM_NORMAL)
        menu_file_export.Append(self.menu_file_export_recent_to_clipboard)
        self.menu_file_export_inspector_to_clipboard = wx.MenuItem(menu_file_export, wx.NewIdRef(), _("Copy Image I&nspector as Command to Clipboard"), _("Paste this command in a launcher"), wx.ITEM_NORMAL)
        menu_file_export.Append(self.menu_file_export_inspector_to_clipboard)
        self.menu_file.Append(wx.ID_FORWARD, _("&Export"), menu_file_export, "")
        ...
        self.menu_tools_browse_library_user = wx.MenuItem(menu_tools_browse_library, wx.NewIdRef(), _("&User"), _("Browse action lists, masks, highlights and fonts"), wx.ITEM_NORMAL)
        menu_tools_browse_library.Append(self.menu_tools_browse_library_user)
        self.menu_tools_browse_library_phatch = wx.MenuItem(menu_tools_browse_library, wx.NewIdRef(), _("&Phatch"), _("Browse action lists, masks, highlights and fonts"), wx.ITEM_NORMAL)
        menu_tools_browse_library.Append(self.menu_tools_browse_library_phatch)
        self.menu_tools.Append(wx.ID_MORE, _("&Browse Library"), menu_tools_browse_library, "")
        self.menu_tools.AppendSeparator()
        ...
        self.menu_tools_update_fonts = wx.MenuItem(menu_tools_update, wx.NewIdRef(), _("&Fonts"), _("Scan for new fonts on your system"), wx.ITEM_NORMAL)
        menu_tools_update.Append(self.menu_tools_update_fonts)
        self.menu_tools.Append(wx.NewIdRef(), _("&Update"), menu_tools_update, "")
