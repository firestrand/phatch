...
TOOLBAR_SPEC: Tuple[object, ...] = (
    ...
    ToolbarDescriptor(
        ...
        label=_("Remove"),
        tooltip=_("Remove the selected action"),
    ...
    ToolbarDescriptor(
        bitmap="ART_GO_UP",
        label=_("Up"),
        tooltip=_("Move the selected action up"),
    ...
    ToolbarDescriptor(
        bitmap="ART_GO_DOWN",
        label=_("Down"),
        tooltip=_("Move the selected action down"),
    ...
    ToolbarDescriptor(
        ...
        tooltip=_("Look up exif and iptc tags"),
    ...
    ToolbarDescriptor(
        bitmap="ART_TIP",
        label=_("Description"),
        tooltip=_("Show description of the action list"),
